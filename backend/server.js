...
// CORS Configuration
app.use(cors({
  origin: ["http://localhost:5173",  "https://www.vanextatech.online" , "https://www.api.raabta.tech", "http://localhost:5174", "http://localhost:3000","https://banquet-automation.vercel.app"],
  credentials: true
}))
